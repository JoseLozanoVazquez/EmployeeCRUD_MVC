...
namespace EmployeeCRUD_MVC.Controllers
{
    public class EmployeesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,FullName,Email,Phone,Position")] Employee employee)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,FullName,Email,Phone,Position")] Employee employee)
        {
            if (id != employee.Id)
            {
                return NotFound();
